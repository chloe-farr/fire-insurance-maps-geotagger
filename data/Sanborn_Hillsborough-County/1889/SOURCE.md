# Sanborn fire insurance map, Tampa, Hillsborough County, Florida — 1889 (Library of Congress)
...
| Resource page | <https://www.loc.gov/resource/g3934tm.g3934tm_g013521889/> |
| Digital id | `g3934tm_g013521889` (Sanborn map no. 01352, 1889 edition) |
| Sheets | 7, each 6450 × 7650 px RGB; file numbers 0001–0007 |
| Files on the LOC storage host | `https://tile.loc.gov/storage-services/service/gmd/gmd393m/g3934m/g3934tm/g3934tm_g013521889/01352_1889-NNNN.jp2` (JPEG 2000 masters, not kept here) |

URLs as given by Chloe (kept verbatim in the manifest's `requested_url`):
  - <https://www.loc.gov/resource/g3934tm.g3934tm_g013521889/?st=gallery>
  - <http://hdl.loc.gov/loc.gmd/g3934tm.g3934tm_g013521889>

## Files here

`01352_1889-0001.png` … `01352_1889-0007.png`: the Library's JPEG 2000 masters decoded once to lossless PNG, full resolution, nothing else changed.
...
save <https://www.loc.gov/resource/g3934tm.g3934tm_g013521889/?fo=json> from a browser as `loc_resource.json` in this directory and run the fetcher again
